<template>
    ...
    >
        ...
        <nodeTitle
            ...
            :node-icon="require('../../image/message.png')"
...
import validateMessageNode from '../../validateUtils/validateMessageNode';
...
export default {
    ...
    methods: {
        initBus() {
            ...
            this.bus.$on('validateConfigById', ({ nodeId }) => {
                if (nodeId === this.getId) {
                    ...
                    const data = validateMessageNode({
                        model: this.model,
                        lf: this.lf
                    });
        ...
        validateFlowChild() {
            const { validateStatus, errResult } = validateMessageNode({
                model: this.model,
                lf: this.lf
            });
