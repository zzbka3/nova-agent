<template>
    ...
    >
        ...
        <nodeTitle
            ...
            :node-icon="require('../../image/agent.png')"
...
import validateWorkFlowNode from '../../validateUtils/validateWorkFlowNode';
...
export default {
    ...
    methods: {
        initBus() {
            ...
            this.bus.$on('validateConfigById', ({ nodeId }) => {
                if (nodeId === this.getId) {
                    ...
                    const data = validateWorkFlowNode({
                        model: this.model,
                        lf: this.lf
                    });
        ...
        validateFlowChild() {
            const { validateStatus, errResult } = validateWorkFlowNode({
                model: this.model,
                lf: this.lf
            });
